...
<!-- <a name="_top"></a>
<div><a href="../../index.md">Home</a> &gt;  <a href="#">v5.1.0</a> &gt; <a href="index.md">Other</a> &gt; InelPanelZone.m</div> -->
...
<li><a href="shape2d" class="code" title="function [N,dNdx,J] = shape2d (nat,xyz,nodix)">shape2d</a>	SHAPE2D shape functions for 4-9 node quadrilateral element</li><li><a href="../../v5.1.0/Utilities/Quadrature/Gauss2d" class="code" title="function [xIP,wIP] = Gauss2d (nIP)">Gauss2d</a>	GAUSS2D Gauss integration rule in two dimensions</li></ul>
